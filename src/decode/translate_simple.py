...
def main():
    ...
    parser.add_argument("--src_code", default="ceb_Latn", help="Source language code (default: ceb_Latn)")
    parser.add_argument("--tgt_code", default="tgl_Latn", help="Target language code (default: tgl_Latn)")
